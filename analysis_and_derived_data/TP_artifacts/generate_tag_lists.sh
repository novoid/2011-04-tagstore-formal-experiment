...
extract_tags_from_store_tgs_files 27 > TP27_raw_tags.txt
...
extract_single_line_tags_from_raw_tags_files 27 >> ../${ALL_TAGS_FILE}
...
wc -l TP27_raw_tags_single_unique.txt | awk '{ print $1 }' >> ../${NUMBER_UNIQUE_TAGS_PER_TP}
...
extract_tags_from_store_tgs_files 19 > TP19_raw_tags.txt
extract_tags_from_store_tgs_files 20 > TP20_raw_tags.txt
extract_tags_from_store_tgs_files 21 > TP21_raw_tags.txt
extract_tags_from_store_tgs_files 23 > TP23_raw_tags.txt
extract_tags_from_store_tgs_files 24 > TP24_raw_tags.txt
extract_tags_from_store_tgs_files 25 > TP25_raw_tags.txt
extract_tags_from_store_tgs_files 26 > TP26_raw_tags.txt
...
dos2unix TP19_raw_tags.txt
dos2unix TP20_raw_tags.txt
dos2unix TP21_raw_tags.txt
dos2unix TP23_raw_tags.txt
dos2unix TP24_raw_tags.txt
dos2unix TP25_raw_tags.txt
dos2unix TP26_raw_tags.txt
...
generate_single_uniq 19
generate_single_uniq 20
generate_single_uniq 21
generate_single_uniq 23
generate_single_uniq 24
generate_single_uniq 25
generate_single_uniq 26
...
extract_single_line_tags_from_raw_tags_files 19 >> ../${ALL_TAGS_FILE}
extract_single_line_tags_from_raw_tags_files 20 >> ../${ALL_TAGS_FILE}
extract_single_line_tags_from_raw_tags_files 21 >> ../${ALL_TAGS_FILE}
extract_single_line_tags_from_raw_tags_files 23 >> ../${ALL_TAGS_FILE}
extract_single_line_tags_from_raw_tags_files 24 >> ../${ALL_TAGS_FILE}
extract_single_line_tags_from_raw_tags_files 25 >> ../${ALL_TAGS_FILE}
extract_single_line_tags_from_raw_tags_files 26 >> ../${ALL_TAGS_FILE}
cat *_raw_tags_single_unique.txt >> ../${SUMMARIZED_TAGS_UNIQUE}
...
wc -l TP19_raw_tags_single_unique.txt | awk '{ print $1 }' >> ../${NUMBER_UNIQUE_TAGS_PER_TP}
wc -l TP20_raw_tags_single_unique.txt | awk '{ print $1 }' >> ../${NUMBER_UNIQUE_TAGS_PER_TP}
wc -l TP21_raw_tags_single_unique.txt | awk '{ print $1 }' >> ../${NUMBER_UNIQUE_TAGS_PER_TP}
wc -l TP23_raw_tags_single_unique.txt | awk '{ print $1 }' >> ../${NUMBER_UNIQUE_TAGS_PER_TP}
wc -l TP24_raw_tags_single_unique.txt | awk '{ print $1 }' >> ../${NUMBER_UNIQUE_TAGS_PER_TP}
wc -l TP25_raw_tags_single_unique.txt | awk '{ print $1 }' >> ../${NUMBER_UNIQUE_TAGS_PER_TP}
wc -l TP26_raw_tags_single_unique.txt | awk '{ print $1 }' >> ../${NUMBER_UNIQUE_TAGS_PER_TP}
