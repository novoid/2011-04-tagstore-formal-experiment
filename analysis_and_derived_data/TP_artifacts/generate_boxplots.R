...
pdf('tag_length_boxplot_orig.pdf')
...
pdf('folder_length_boxplot_orig.pdf')
...
pdf('folder_and_tag_length_boxplot_orig.pdf')
...
pdf('folder_and_tag_uniques_boxplot_orig.pdf')
...
avnroftags <- read.table("../transcripts/average_nr_of_tags_-_list.csv")
avnrofparenfolders <- read.table("folders_list_of_average_nr_of_parentfolders_per_TP.csv")
pdf('average_nr_of_parentfolders_vs_average_nr_of_tags_boxplot_orig.pdf')
